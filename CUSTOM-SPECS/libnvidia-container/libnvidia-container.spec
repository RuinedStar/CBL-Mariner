...
BuildRequires: make, which, rpcsvc-proto, libseccomp-devel, libtirpc-devel, elfutils
Version: 1.3.3
Release: 2
Summary: NVIDIA container runtime library

Source0: https://github.com/NVIDIA/libnvidia-container/archive/v%{version}.tar.gz
Source1: 450.57.tar.gz
Patch0:  0001-Fix-Hash-for-Release-Package.patch
Patch1:  0002-Avoid-Downloading-Dependencies.patch
Patch2:  0003-Fix-RPC-RPC.h-not-Found.patch
Requires: libseccomp, libtirpc, elfutils
...
%changelog
* Wed Mar 17 2021 MICROSOFT(via BEYONDSOFT) <v-arthurlai@microsoft.com> 1.3.3-2
- Bump 1.3.3-1 to 1.3.3-2
