...
Source0: https://github.com/NVIDIA/nvidia-container-toolkit/archive/v%{version}.tar.gz
Patch0:  0001-Build-Offline.patch
...
%build
export GO_BUILD_DIR=../go/src/nvidia-container-toolkit
mkdir -p $GO_BUILD_DIR
cp -r * $GO_BUILD_DIR
pushd $GO_BUILD_DIR
make binary
popd
mv $GO_BUILD_DIR/nvidia-container-toolkit .
...
%changelog
* Wed Mar 17 2021 MICROSOFT(via BEYONDSOFT) <v-arthurlai@microsoft.com> 1.4.2-2
- Bump 1.4.2-1 to 1.4.2-2
